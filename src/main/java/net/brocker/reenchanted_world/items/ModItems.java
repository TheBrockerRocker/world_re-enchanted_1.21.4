...
public class ModItems {
    ...
    public static final Item PINK_CARROT = register(
            new Item(new Item.Settings().food(ModFoodCompnents.PINK_CARROT, ModFoodCompnents.PINK_CARROT_EFFECT).registryKey(getItemRegistryKey(getId("pink_carrot")))), getId("pink_carrot"));
